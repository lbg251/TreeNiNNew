...
#     sample_name='top_qcd_jets_antikt_CA'
  ...
  #   sg='tt'
  if toptag_reference_dataset==True:
      sample_name='top_tag_reference_dataset'
  else:
      sample_name=''
  sg='ttbar' 
...
#     with open(test_data, "wb") as f: pickle.dump((test_batches,w), f)
  ...
  if toptag_reference_dataset:
    ...
    #     toptag_reference_test=dir_jets_subjets+'/tree_test_jets_40001.pkl'
        ...
        toptag_reference_train=dir_jets_subjets+'/Rjet_0.8Clustering_'+str(algo)+'tree_train_jets.pkl'
        toptag_reference_val=dir_jets_subjets+'/Rjet_0.8Clustering_'+str(algo)+'tree_val_jets.pkl'
        toptag_reference_test=dir_jets_subjets+'/Rjet_0.8Clustering_'+str(algo)+'tree_test_jets.pkl'
