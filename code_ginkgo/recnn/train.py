...
if __name__=='__main__':  
  ...
  #sample_name=str(args.model_dir).split('/')[-1]
  ...
  sample_filename=sample_name+'_'+algo+'_'+str(params.myN_jets)+'jets'
  

  logging.info('sample_filename={}'.format(sample_filename))
  
  train_data=dir_jets_subjets+'train_'+sample_filename+'.pkl'
  val_data=dir_jets_subjets+'dev_'+sample_filename+'.pkl'
  test_data=dir_jets_subjets+'test_'+sample_filename+'.pkl'
