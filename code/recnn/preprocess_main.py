...
#   test_data=data_dir+'/tree_test_jets_4000_R_0.3_rot_boost_rot_flip.pkl'
#   train_data=data_dir+'/tree_train_jets_4000_R_0.3_rot_boost_rot_flip.pkl'
#   val_data=data_dir+'/tree_val_jets_4000_R_0.3_rot_boost_rot_flip.pkl'
...
#     with open(test_data, "wb") as f: pickle.dump((test_batches,w), f)
  ...
  if toptag_reference_dataset:
    ...
    #     toptag_reference_test=dir_jets_subjets+'/tree_test_jets_40001.pkl'
        ...
        print("dir_jets_subjets=",dir_jets_subjets)
        print("sample_name=",sample_name)

        toptag_reference_train=dir_jets_subjets+'/tree_test_jets_4000_R_0.3_rot_boost_rot_flip.pkl'
        toptag_reference_test=dir_jets_subjets+'/tree_train_jets_4000_R_0.3_rot_boost_rot_flip.pkl'
        toptag_reference_val=dir_jets_subjets+'/tree_val_jets_3000_R_0.3_rot_boost_rot_flip.pkl'
