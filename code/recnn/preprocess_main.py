...
#     with open(test_data, "wb") as f: pickle.dump((test_batches,w), f)
  ...
  if toptag_reference_dataset:
    ...
    #     toptag_reference_test=dir_jets_subjets+'/tree_test_jets_40001.pkl'
        ...
        toptag_reference_train=dir_jets_subjets+'/test_data.pkl'
        toptag_reference_val=dir_jets_subjets+'/test_data.pkl'
        toptag_reference_test=dir_jets_subjets+'/test_data.pkl'
