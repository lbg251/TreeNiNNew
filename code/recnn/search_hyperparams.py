...
# top_tag_reference_dataset_NiNRecNN_kt_full_test_2L4WleavesInnerNiNuk_lr_0.002_decay_09_batch_400_epochs_40_hidden_50_Njets_1200000_features_7
    multi_scan(learning_rates=[2e-3],decays=[0.9], batch_sizes=[16,32,64,128],num_epochs=[30],hidden_dims=[20,40,80,160,320,640], jet_numbers=[1200000], Nfeatures=7,dir_name='top_tag_reference_dataset',name=architecture+'_last_kt_full_test_2L4WleavesInnerNiNuk', info='',sample_name=args.sample_name,Nrun_start=NrunStart,Nrun_finish=NrunFinish) #gpu1   
