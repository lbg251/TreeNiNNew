...
if __name__ == "__main__":
    ...
    def multi_scan(jet_algorithm,learning_rates,decays, batch_sizes,num_epochs,hidden_dims,jet_numbers,Nfeatures,dir_name=None,name=None, info=None, sample_name, Nrun_start=0,Nrun_finish=1):
