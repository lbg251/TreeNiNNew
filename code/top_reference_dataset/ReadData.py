...
dataformat = sys.argv[2] #datafile type (.h5 or .pkl)
setname = sys.argv[3]    #which dataset to read ("test", "train", "val")
setdata = sys.argv[4]    #path to dataset (including file name, i.e. "/in_data/test.pkl")
print(str(dataformat), str(setname), str(setdata))
