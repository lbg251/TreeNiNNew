...
# setenv PYTHONPATH ${PYTHONPATH}:/Users/laurengreenspan/fastjet-install/lib/python3.9/site-packages
# 
...
import sys, os, copy
#sys.path.append("/Users/laurengreenspan/fastjet-install/lib/python3.9/site-packages")
...
dir_subjets= sys.argv[3] #Input data, typically out_data/
out_dir=sys.argv[4]

##Change Rjet and Clustering Algorithm to input variables 


# Turn to true if preprocessing (shift, rotate, etc) - Read from cardfile
# rot_boost_rot_flip=True
#rot_boost_rot_flip=False
# Rjet=sys.argv[5]
# jetdef_tree = sys.argv[6]
#-------------------------------------------------------------------------------------------------------------
#Read cardfile
...
#         event=pf.make_pseudojet(element['leaves'])
    ...
    # Recluster jet constituents
        out_jet = pf.recluster(event, Rjet,str(jetdef_tree))       
...
print('Saving at '+str(out_filename))
